    ...
    return tilelive.load(sourceURI, function(err, source) {
      ...
      return tessera.getInfo(source, function(err, info) {
        ...
        if (z < info.minzoom || z > info.maxzoom) {
          ...
          return callback(null, null, populateHeaders({}, params, { 404: false, invalidZoom: true }), 204);
        }
        ...
        if (x < xyz.minX ||
          ...
          return callback(null, null, populateHeaders({}, params, { 404: false, invalidCoordinates: true }), 204);
        }
        ...
        return source.getTile(z, x, y, function(err, data, headers) {
          ...
          if (err) {
            if (err.message.match(/(Tile|Grid) does not exist/)) {
              return callback(null, null, populateHeaders(headers, params, { 404: false }), 204);
            }
